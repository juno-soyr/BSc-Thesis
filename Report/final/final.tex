...
\subsection{Basic Syntax and Operations}
...
\subsubsection{Leftmost Outermost}
...
\end{center}
This means that every term $t \in \Lambda$ has at most one leftmost-outermost redex, and therefore every reduction sequence using this ordering is unique and deterministic. The Leftmost Outermost strategy therefore reduces the leftmost outermost redex always, and it is a strongly normalizing strategy. An example:
\begin{equation*}
