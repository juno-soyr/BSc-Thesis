...
/* package lambda-interpreter-0.1.0.0 */
#ifndef VERSION_lambda_interpreter
#define VERSION_lambda_interpreter "0.1.0.0"
#endif /* VERSION_lambda_interpreter */
#ifndef MIN_VERSION_lambda_interpreter
#define MIN_VERSION_lambda_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lambda_interpreter */
...
#define CURRENT_COMPONENT_ID "lambda-interpreter-0.1.0.0-inplace-interpreter"
